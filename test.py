...
def arguments():
    ...
    parser_group.add_argument(
        ...
        help='Период осреднения данных (время окончания осреднения данных - период осреднения данных = '
    ...
    parser_group.add_argument(
        '-t', '--timeout', type=float, default=60,
    ...
    return namespace.finish_time, namespace.period, namespace.avg_time, namespace.col_string, namespace.timeout
